...
<head>
        ...
        <script src="<?php echo base_url('asset/siswa/ajaxSIswa.js'); ?>"></script>
</head>
<body>
			...
			<div class="row-fluid">
				...
				<div id="content" class="span12">
					...
					<ul class="breadcrumb">
						...
						<li>
							<i class="icon-edit"></i>
							<a href="index.php/nilai/do_assesment_by_student">Penilaian Diri Sendiri dan Antar Teman</a>
						</li>
					</ul>
					<div class="row-fluid">
						<div class="span8" ontablet="span6" >
							...
							<div class="box-content">
								<ul class="dashboard-list">
									<li>
										<strong>Nama:</strong> <?php echo $dataSiswa['NAMA_PD'] ?><br>
										<strong>Kelas:</strong>  <?php echo $dataSiswa['NAMA_KELAS'] ?><br>
										<strong>Sekolah:</strong>  <?php echo $dataSiswa['NAMA_SEKOLAH'] ?><br>
										<strong>Semester:</strong>  <?php echo $dataSiswa['semester_thn_ajar'] ?> / <?php echo $dataSiswa['NAMA_TAHUN_AJAR'] ?><br>	                                
									</li>
								</ul>
							</div>
						</div>
						...
						<form class="form-horizontal">
							...
							<fieldset>
							  <div class="control-group">
								...
								<div class="controls">
								  <select id="pilihMapel" href="<?php echo site_url('nilai/getMapelList') ?>"  data-rel="chosen">
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <select id="pilihKI" href="<?php echo site_url('nilai/getKIList') ?>"  data-rel="chosen">
							   ...
							   <div class="control-group">
								...
								<div class="controls">
								  <select id="pilihMetode" href="<?php echo site_url('nilai/getMetodeList') ?>"  data-rel="chosen">
							   ...
							   <div class="control-group">
								...
								<div class="controls">
								  <select id="pilihIndikator" href="<?php echo site_url('nilai/getIndikatorList') ?>"  data-rel="chosen">
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <select id="pilihKD" href="<?php echo site_url('nilai/getKDList') ?>"  multiple data-rel="chosen">
									<option value='null'>-- Pilih Kompetensi Dasar --</option>
								  </select>
								</div>
							  </div>
							  <button href="<?php echo site_url('nilai/penilaianOlehSiswa') ?>" class="btn btn-primary" id="cariBtn">Cari Data</button>
