											...
											<table class="table table-bordered">
												  ...
												  <tbody>
													...
													<tr>
														...
														<td class="center">
																  <input type="radio" name="<?php echo $a->ID_SISWA?>" id="optionsRadios" value="1" <?php if($siswa!=null && $siswa["NILAI"]==1) echo "checked" ; ?>	>															
														</td> 
														<td class="center">
																  <input type="radio" name="<?php echo $a->ID_SISWA?>" id="optionsRadios" value="2" <?php if($siswa!=null && $siswa["NILAI"]==2) echo "checked" ;?> >																
														</td>
														<td class="center">
																  <input type="radio" name="<?php echo $a->ID_SISWA?>" id="optionsRadios" value="3" <?php if($siswa!=null && $siswa["NILAI"]==3) echo "checked" ;?> >																
														</td>
														<td class="center" >
																  <input type="radio" name="<?php echo $a->ID_SISWA?>" id="optionsRadios" value="4" <?php if($siswa!=null && $siswa["NILAI"]==4) echo "checked" ;?> >															
														</td>                               
													</tr>   
													<?php 
