			...
			<div class="row-fluid">
				...
				<div id="content" class="span12">
					...
					<ul class="breadcrumb">
						...
						<li>
							<i class="icon-edit"></i>
							<a href="<?php echo site_url ('pesertadidik/tambahDataPesertaDidik')?>">Tambah Data Peserta Didik</a>
						</li>
					</ul>
						...
						<div class="row-fluid sortable">
								<div class="box span12">
									...
									<div class="box-content">
										<form method="POST" action="<?php echo site_url('pesertadidik/doInsert_PesertaDidik'); ?>" class="form-horizontal">
										  <fieldset>
											...
											<div class="control-group">
												<label class="control-label" for="focusedInput">Alamat Peserta Didik</label>
												<div class="controls">
												  <input class="input-xlarge focused" name="alamat_siswa" id="focusedInput" type="text" value="">
												</div>
											  </div>
											<div class="control-group">
												<label class="control-label" for="focusedInput">Telepon Peserta Didik</label>
												<div class="controls">
											...
											<div class="form-actions">
												...
												<a href="<?php echo site_url ('ptk/DataPesertaDidik');?>">Batal</a>
											  </div>
