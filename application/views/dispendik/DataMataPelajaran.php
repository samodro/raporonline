					...
					<ul class="breadcrumb">
						...
						<li>
							...
							<div class="row-fluid sortable">
								<div class="box span8">
									<div class="box-header" data-original-title>
										<h2><i class="halflings-icon white user"></i><span class="break"></span>Kelola Data Mata Pelajaran</h2>
									</div>
									<div class="box-content">
										<form class="form-horizontal">
											<form class="form-horizontal">
											<?php if($selected['KODE_MAPEL']=="")
											{
										  ...
										  <fieldset>
											...
											<div class="control-group">
												<label class="control-label" for="focusedInput">Kode Mata Pelajaran</label>
												<div class="controls">
												  <input id="idMapel"  class="input-xlarge focused" id="focusedInput" type="text" value="<?php echo $selected['KODE_MAPEL']; ?>" >
												</div>
											  </div>
											<div class="control-group hidden-phone">
											  <label class="control-label" for="textarea2">Nama Mata Pelajaran</label>
											  <div class="controls">
							...
							<div class="row-fluid sortable">
								...
								<div class="box-header" data-original-title>
									<h2><i class="halflings-icon white user"></i><span class="break"></span>Data Master Mata Pelajaran</h2>
								</div>
								<div class="box-content">
									<table class="table table-striped table-bordered bootstrap-datatable datatable">
									  ...
									  <tbody>
										...
										<tr>
											...
											<td class="center">
												<a href="<?php echo site_url ('mapel/DataMataPelajaran/'.$a->KODE_MAPEL)?>"><button class="btn btn-mini btn-warning">Sunting</button></a>
												<a href="<?php echo site_url ('mapel/hapusDataMapel/'.$a->KODE_MAPEL)?>"><button class="btn btn-mini btn-danger">Hapus</button></a>
											</td>
										</tr>
										<?php } ?>
									</tbody>
