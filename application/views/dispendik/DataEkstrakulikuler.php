				...
				<div id="content" class="span12">
					...
					<ul class="tabs">
							...
							<li class="tab-link" data-tab="tab-2"><a href="index.php/mapel/DataMuatanLokal">Muatan Lokal</a></li>
						...
						<div id="tab-3" class="tab-content current">
							<div class="row-fluid sortable">
								<div class="box span8">
									<div class="box-header" data-original-title>
										<h2><i class="halflings-icon white user"></i><span class="break"></span>Kelola Ekstrakulikuler</h2>
									</div>
										...
										<form class="form-horizontal">
										  <fieldset>
											...
											<div class="control-group hidden-phone">
											  <label class="control-label" for="textarea2">Kode Ekstrakulikuler</label>
											  <div class="controls">
												  <input class="input-xlarge focused" id="focusedInput" type="text" value="">
												</div>
											</div>
											<div class="control-group hidden-phone">
											  <label class="control-label" for="textarea2">Nama Ekstrakulikuler</label>
											  <div class="controls">
												  <input class="input-xlarge focused" id="focusedInput" type="text" value="">
												</div>
											</div>
							...
							<div class="row-fluid sortable">
								...
								<div class="box-header" data-original-title>
									<h2><i class="halflings-icon white user"></i><span class="break"></span>Data Master Ekstrakulikuler</h2>
								</div>
								<div class="box-content">
