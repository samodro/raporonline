				...
				<div id="content" class="span12">
					...
					<ul class="tabs">
							<li class="tab-link current" data-tab="tab-2">Data Master Penilaian</li>
							...
							<div class="row-fluid sortable">
								<div class=" span12">
									...
									<div class="box-content">
										<form method="POST" action="<?php echo site_url('penilaian/doInsert_IndikatorPenilaian_Parent'); ?>" class="form-horizontal">
										  <fieldset>

											<div class="control-group">
												<label class="control-label" for="focusedInput">Kode Jenis Penilaian</label>
												<div class="controls">
												  <input class="input-xlarge focused" name="kode_penilaian" id="focusedInput" type="text" value="">
												</div>
												<div class="control-group hidden">
												<label class="control-label" for="focusedInput">MST Kode Indikator  Penilaian</label>
												<div class="controls">
												  <input class="input-xlarge focused" name="mst_kode_penilaian" id="focusedInput" type="text" value="">
												</div>
											  </div>
											<div class="control-group">
											...
											<div class="control-group">
												...
												<div class="controls">
												  <select id="kode_mapel"  data-rel="chosen" name="kode_mapel">
											  ...
											  <div class="control-group">
												...
												<div class="controls">
												  <input class="input-xlarge focused" name="indikator_penilaian" id="focusedInput" type="text" value="">
												</div>
											  </div>
											  <div class="control-group">
												<label class="control-label" for="focusedInput">Deskripsi Penilaian</label>
												<div class="controls">
												  <input class="input-xlarge focused" name="deskripsi_penilaian" id="focusedInput" type="text" value="">
												</div>
											  </div>
											  <div class="control-group hidden">
												<label class="control-label" for="focusedInput">Level Penilaian</label>
												<div class="controls">
												  <input class="input-xlarge focused" name="level_penilaian" id="focusedInput" type="text" value="1">
												</div>
											  </div>
											  <div class="control-group">
												<label class="control-label" for="focusedInput">Kata Kunci</label>
												<div class="controls">
												  <input class="input-xlarge focused" name="kata_kunci" id="focusedInput" type="text" value="">
												</div>
											  </div>
											  <div class="control-group">
												<label class="control-label" for="focusedInput">Penilaian oleh</label>
												  ...
												  <div class="controls">
												  	<label class="radio">
														<input type="radio" name="is_guru" id="optionsRadios1" value="" checked="">
														Guru dan Siswa
													  </label><br>
													  <label class="radio">
