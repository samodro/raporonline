							...
							<div class="row-fluid sortable">
								<div class=" span12">
									<div class="box-header" data-original-title>
										<h2><i class="halflings-icon white edit"></i><span class="break"></span>Tambah Data Indikator Penilaian</h2>
									</div>
									<div class="box-content">
										<form method="POST" action="<?php echo site_url('penilaian/doInsert_IndikatorPenilaian'); ?>" class="form-horizontal">
										  <fieldset>
										  	<?php foreach($daftar->result() as $a):?>
										  	<div class="control-group">
												<label class="control-label" for="focusedInput">Sumber Komponen penilaian</label>
												<div class="controls">
												  	<input class="input-xlarge uneditable-input"  name="mst_kode_penilaian" id="focusedInput" type="text" value="<?php echo $a->KODE_PENILAIAN;?>">
											...
											<div class="control-group">
											  ...
											  <?php foreach($level_penilaian->result() as $a):?>
