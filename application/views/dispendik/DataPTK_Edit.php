									...
									<div class="box-content">
										...
										<table>
											...
											<div class="control-group">
												<label class="control-label" for="id_sekolah">Sekolah</label>
												<div class="controls">
											...
											<div class="control-group hidden">
												<label class="control-label" for="selectError">NUPTK</label>
													<div class="controls">
											...
											<div class="control-group">
												...
												<div class="controls">
												  ...
												  <select id="is_fungsional"  data-rel="chosen" name="is_fungsional">
												  	<?php $selected2 = $a->IS_FUNGSIONAL; ?>
												  	<?php if($selected2 == TRUE){ ?>
												  		<option selected='selected'><?php echo $selected2 ?></option-->
												  	<?php  } ?>
											...
											<div class="form-actions">
												<a href="<?php echo site_url ('ptk/doEdit_DataPTK'.$a->ID_PTK) ?>"><button class="btn btn-primary">Simpan</button></a>
